...
function Cal_J_R(JR,JR_orb,V_R_iWn_block,G_R_iWn_block,G_mR_iWn_block,Rv,atom_list12_ind,R_grid_num,iWnlist,wind,beta,hamiltonian_info,mag_order)
    ...
    # println("Cal_J_R() ... ")
    # println("atom_list12_ind : $(atom_list12_ind)" )
    # println("mag_order[atom_list12_ind] : $(mag_order[atom_list12_ind])" )
    ...
    JR[atom_list12_ind][Rv_revised[1]+1,Rv_revised[2]+1,Rv_revised[3]+1] += (J_ud+J_du)
    JR_orb[atom_list12_ind][Rv_revised[1]+1,Rv_revised[2]+1,Rv_revised[3]+1,:,:] += (J_ud_orb.+J_du_orb)
