...
# Check if the Julia package 'KaiEDJ' is installed 
if ! julia -e 'import Pkg; haskey(Pkg.dependencies(), "KaiEDJ") ? 0 : 1'; then 

    echo "Package KaiEDJ is not installed. Running setup.jl..." 
    $JULIA setup.jl 

else

    echo "Package KaiEDJ is already installed." 
