...
function input_handler(DMFT_Jx_option)
   ...
   if (DMFT_Jx_option.Calculation_mode == "DMFT")
        ...
        imp_dc  =  DMFT_Jx_option.imp_dc;
        if ( occursin( "FLL", imp_dc_type ) ||  occursin( "Fll", imp_dc_type ) ||  occursin( "fll", imp_dc_type ) )
    ...
    elseif ((DMFT_Jx_option.Calculation_mode == "Jx-DMFT") || (DMFT_Jx_option.Calculation_mode == "Jx-DMFT-private") || (DMFT_Jx_option.Calculation_mode == "DMFT+MFT"))
    ...
    elseif (DMFT_Jx_option.Calculation_mode == "Jx0" || DMFT_Jx_option.Calculation_mode == "MFT")
        Calculation_mode = DMFT_Jx_option.Calculation_mode
        println(" Calculation mode :", Calculation_mode)
    ...
    elseif (DMFT_Jx_option.Calculation_mode == "Spinwave" || DMFT_Jx_option.Calculation_mode == "Magnon")
        Calculation_mode = DMFT_Jx_option.Calculation_mode
        println(" Calculation mode :", Calculation_mode)
